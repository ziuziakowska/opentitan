...
otbn_library = rv_rule(
    ...
    attrs = {
        ...
        "_riscv32_as": attr.label(
            default = Label("@lowrisc_rv32imcb_binutils//:bin/as"),
...
otbn_binary = rv_rule(
    ...
    attrs = {
        ...
        "_riscv32_ar": attr.label(
            default = Label("@lowrisc_rv32imcb_binutils//:bin/ar"),
            allow_single_file = True,
            executable = True,
            cfg = "exec",
        ),
        ...
        "_riscv32_ld": attr.label(
            default = Label("@lowrisc_rv32imcb_binutils//:bin/ld"),
            allow_single_file = True,
            executable = True,
            cfg = "exec",
        ),
        "_riscv32_objcopy": attr.label(
            default = Label("@lowrisc_rv32imcb_binutils//:bin/objcopy"),
            allow_single_file = True,
            executable = True,
            cfg = "exec",
        ),
